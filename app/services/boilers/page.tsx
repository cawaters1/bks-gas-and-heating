...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Boiler Installation & Servicing West London | BKS Gas & Heating",
    description: "Gas Safe registered boiler installation, servicing and repairs across West London. Worcester Bosch, Vaillant, Ideal and all major brands. Free estimates.",
    url: "https://bksgasandheating.com/services/boilers",
  },
};
